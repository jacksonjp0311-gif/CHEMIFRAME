...
intent = load_intent("examples/intent_sequence_01.json")
report = run_pipeline(intent, simulate=True)

print("SEQUENCE INTENT:", report["intent"])
print("SEQUENCE ROUTE:", report["route"])
print("SEQUENCE CONTRACTS:", report["contracts"])
